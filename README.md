...
* For the nonlocal GGA, the stress predicted by the GPAW interface is sometimes inaccurate compared to finite-difference stress, and whether it is depends on the parameterization of the functional. We are currently investigating this. This issue has not been observed for the nonlocal meta-GGA.
